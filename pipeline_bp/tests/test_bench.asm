...
addi s6,zero,3  #走马灯计数   # s6 = 3
zmd_loop:

addi s0, s0, 1    #计算下一个走马灯的数据  # s0 = 2
andi s0, s0, 15  
...
addi s0, s0, 1   #计算下一个走马灯的数据 s0=1
addi t6,zero,15  # t6=15
and s0, s0, t6   # s0=1
slli s0, s0, 28  # s0=10000000   
...
srli s3, s3, 4  #走马灯右移 01111111
or s3, s3, s0   #11111111
